  ...
  >
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-4 pt-4 text-gray-600 border-t">
          Example of two options how to reuse common components styles
          <ol class="list-decimal list-inside">         
            <li>As a separate component (left button)</li>         
            <li>As a global style (right button)</li>       
          </ol>    
          <button class="mt-4 ml-2 btn" @click="count--">Decrease</button>
          <button class="mt-4 ml-2 btn" @click="count++">Increase</button>
          <p class="mt-2 font-semibold text-blue-600">count is: {{ count }}</p>
        </p>
