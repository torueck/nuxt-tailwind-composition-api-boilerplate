    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          ...
          <a href="https://tailwindcss.com/docs" target="_blank" class="link"
            >official Tailwind CSS documentation</a
          >
          and also have a look at the
          <a href="https://tailwindcss.nuxtjs.org/" target="_blank" class="link"
            >Nuxt/Tailwind module</a
          >.
        </p>

        <example-counter class="mt-4" />

        <p class="mt-4 pt-4 text-gray-800 border-t">
          To get started, remove everything in
          <code class="inline-code">components/</code>, remove or edit the
          example styles in
